...
if __name__ == "__main__":
    ...
    axs1[1, 0].plot(core_v1_D,dense_v1[9], label = "v1-10000")
    axs1[1, 0].plot(core_v1_D,dense_v2[7], label = "v2-3000")
    axs1[1, 0].plot(core_v1_D,dense_v2[8], label = "v2-5000")
    axs1[1, 0].plot(core_v1_D,dense_v2[9], label = "v2-10000")
    ...
    axs1[1, 1].plot(core_v1_D,dense_v1_speedup[9], label = "v1-10000")
    axs1[1, 1].plot(core_v1_D,dense_v2_speedup[7], label = "v2-3000")
    axs1[1, 1].plot(core_v1_D,dense_v2_speedup[8], label = "v2-5000")
    axs1[1, 1].plot(core_v1_D,dense_v2_speedup[9], label = "v2-10000")
    ...
    #OpenMP
    #runtime
    axs1[2, 0].plot(core_v4_D,dense_v4, label = "OpenMP-optimal")
    axs1[2, 0].plot(nodes_dense,dense_seq, label = "Sequential")
    ...
    fig1.suptitle('Figure 2: Sparse Graph Runtime and Speedup Summary')
